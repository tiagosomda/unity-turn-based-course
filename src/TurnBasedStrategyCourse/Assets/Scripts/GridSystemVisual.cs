...
public class GridSystemVisual : MonoBehaviour
{
    ...
    {
        Material material = GetVisualTypeMaterial(gridVisualType);
    ...
    private void UpdateGridVisuals()
    {
        ...
        switch(selectedAction)
        {
            ...
            case GrenadeAction grenadeAction:
                ...
                break;
            case SaberAction saberAction:
                gridVisualType = GridVisualType.Red;
                ShowGridPositionRangeSquare(selectedUnit.GetGridPosition(), saberAction.GetMaxSwordDistance(), GridVisualType.RedSoft);
                break;
        }
    ...
    private Material GetVisualTypeMaterial(GridVisualType gridVisualType)
    {
        ...
        Debug.LogError("Could not find grid visual type material for grid visual type " + gridVisualType);
        return null;
    }
}
